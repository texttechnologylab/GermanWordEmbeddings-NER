...
The pre-trained word embeddings produced with this morphological processing are provided under the following [link](https://www.texttechnologylab.org/resource-size-matters-neural-named-entity-recognition-for-german-in-2018/). 
